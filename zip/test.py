...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default=r"C:\Program Files (x86)\Eclipse\Sumo\mynet.rou.xml",
    ...
    prs.add_argument("-maxgreen", dest="max_green", type=int, default=500, required=False, help="Maximum green time.\n")
    ...
    env = SumoEnvironment(
        net_file=r"C:\Program Files (x86)\Eclipse\Sumo\net3.net.xml",
    ...
    for run in range(1, args.runs + 1):
        ...
        for ts, agent in ql_agents.items():
            agent.save_q_table(f'q_table_{ts}_{experiment_time}.pkl')