...
# Use the environment with the correct setup
env = DummyVecEnv([lambda: SumoEnvironment(config_path, render_mode='human')])

model = PPO("MlpPolicy", env, verbose=1, learning_rate=0.001, gamma=0.99, ent_coef=0.01)
# Training the model
...
# Create a single instance of the environment for simplicity
